                ...
                <div class="row">
                    <div class="col-xl-9 mx-auto">
                        <div class="cta-inner bg-faded text-center rounded">
							...
							<a style="padding:10px;" class="btn btn-primary btn-block" href="catproflieDbInsert.do">기록하기</a>
	    					<a style="padding:10px; margin:10px;" class="btn btn-primary btn-block" href="measure.do">기록안함</a>
                        </div>
                    </div>
                </div>
            </div>
