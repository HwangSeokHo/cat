	            ...
	            <div class="cta-inner bg-faded text-center rounded">
					<center>
						...
						<c:if test="${ empty loginMember }">
							...
							<form action="login.do" method="post">
								<div id="loginBox" class="lineA" align="right">
									...
									<h7 style="display:inline">방문을 환영합니다.</h7>
						...
						<c:if test="${ !empty loginMember and loginMember.admin_ok ne 'Y'}">
							<div id="loginBox" class="lineA" align="right">
								&nbsp; &nbsp;&nbsp; &nbsp;<img  style="display:inline" width="25px" height="25px" src="${ pageContext.servletContext.contextPath }/resources/static/img/cimg6.png">
								<h5 style="display:inline;">${ sessionScope.loginMember.user_name } 님</h5>&nbsp;<img  style="display:inline" width="25px" height="25px" src="${ pageContext.servletContext.contextPath }/resources/static/img/cimg5.png"><br><br>
